...
- bc3a5c0: batch: opt-in safety net for triggering rows that no job ever runs for
...
- bcccda6: Ship dist/console in the npm tarball again. `npm publish` re-runs the `prepare`
