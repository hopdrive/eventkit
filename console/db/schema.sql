-- ---------------------------------------------------------------------------
-- Imported verbatim from hasura-event-detector's legacy observability plugin
-- (src/plugins/observability/model/schema.sql) as part of the EventKit
-- Console migration (Phase C1, docs/planning/console-migration-plan.md).
--
-- Migration 001_add_source_job_id_up.sql is already folded into this file
-- (see the `source_job_id` column + fk_invocations_source_job_id
